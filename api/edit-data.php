...
$sql = "SELECT
    ...
    SUM(CASE WHEN b.trx_status = 'not paid' THEN c.late_bills ELSE 0 END) + SUM(CASE WHEN b.trx_status = 'waiting' OR b.trx_status = 'not paid' THEN b.trx_amount ELSE 0 END) AS tagihan,
    $sql_semester, 
